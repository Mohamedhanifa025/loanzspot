...
return [
    ...
    'lead_maker_management'                      => 'Lead Maker Management',
    'lead_makers'                                => 'Lead Makers',
    'lead_maker'                                 => [
        'title'          => 'Lead Makers',
        'title_singular' => 'Lead Maker',
        'my_profile'     => 'My Profile',
        'fields'         => [
            'id'                       => 'ID',
            'id_helper'                => '',
            'lead_maker_id'                   => 'Lead Maker ID',
            'lead_maker_id_helper'            => '',
            'name'                     => 'Name',
            'name_helper'              => '',
            'joining_date'             => 'Joining Date',
            'joining_date_helper'      => '',
    ...
    'loan'                              => [
        'title'          => 'Loans',
        'title_singular' => 'loan',
        'title_apply_load'=> 'Apply Loan',
        'fields'         => [
            'id'                 => 'ID',
            'id_helper'          => '',
            'crm_number'               => 'CRM Number',
            'name'               => 'Name',
            'salary'               => 'Salary',
            'salary_helper'               => '',
            'location'               => 'Location',
    ...
    'payment_transfer' => 'Payment History',
    'referral'                              => [
        'title'          => 'Referrals',
    ...
    'setting'                              => [
        ...
        'reward_title_singular' => 'Rewards Setting',
        'smtp_title_singular' => 'SMTP Setting',
        'app_title_singular' => 'App Setting',
        'fields'         => [
            'id'                 => 'ID',
            'id_helper'          => '',
            'name'               => 'Name',
            'name_helper'        => '',
            'primary_reward_value'               => 'Primary Reward Value',
            'primary_reward_value_helper'        => '',
            'secondary_reward_value'               => 'Secondary Reward Value',
            'secondary_reward_value_helper'        => '',
            'territory_reward_value'               => 'Territory Reward Value',
            'territory_reward_value_helper'        => '',
            'smtp_host'               => 'SMTP Host',
            'smtp_host_helper'        => '',
            'smtp_port'               => 'SMTP Port',
            'smtp_port_helper'        => '',
